...
const CarritoProducto: React.FC<CarritoProductoProps> = ({
  ...
  <div className="carrito-producto nuevo-layout">
    ...
    <div className="carrito-producto-info">
        <h3 className="carrito-producto-marca">{producto.titulo}</h3>
        <button
      ...
      <div className="carrito-producto-precio-box">
        ...
        <div className="precios-container">
          <div className="precio-row">
            ...
            <span className="value carrito-producto-precio">{producto.precioCLP}</span>
          </div>
            
          {producto.cantidad > 1 && (
            <div className="precio-row subtotal">
              <span className="label">Subtotal</span>
              <span className="value carrito-producto-subtotal">{producto.subtotalCLP}</span>
            </div>
          )}
        </div>
      </div>
